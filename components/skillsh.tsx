...
export default function Skillsh() {
  ...
  return (
    <section id="skills" className="py-16">
      <h2 className="text-3xl font-medium mx-2 mx-5 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-700 animate-wave py-10"> Soft-Skills</h2>
